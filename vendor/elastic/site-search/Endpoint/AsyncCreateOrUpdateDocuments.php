...
/**
 * Implementation of the AsyncCreateOrUpdateDocuments endpoint.
 *
 * @package Elastic\SiteSearch\Client\Endpoint
 */
class AsyncCreateOrUpdateDocuments extends \Elastic\OpenApi\Codegen\Endpoint\AbstractEndpoint
{
    // phpcs:disable
    /**
     * @var string
