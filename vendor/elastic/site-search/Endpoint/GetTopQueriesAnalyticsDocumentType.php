...
/**
 * Implementation of the GetTopQueriesAnalyticsDocumentType endpoint.
 *
 * @package Elastic\SiteSearch\Client\Endpoint
 */
class GetTopQueriesAnalyticsDocumentType extends \Elastic\OpenApi\Codegen\Endpoint\AbstractEndpoint
{
    // phpcs:disable
    /**
     * @var string
