...
/**
 * Implementation of the GetTopNoResultQueriesAnalyticsEngine endpoint.
 *
 * @package Elastic\SiteSearch\Client\Endpoint
 */
class GetTopNoResultQueriesAnalyticsEngine extends \Elastic\OpenApi\Codegen\Endpoint\AbstractEndpoint
{
    // phpcs:disable
    /**
     * @var string
