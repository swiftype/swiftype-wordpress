...
/**
 * Implementation of the GetSearchCountAnalyticsDocumentType endpoint.
 *
 * @package Elastic\SiteSearch\Client\Endpoint
 */
class GetSearchCountAnalyticsDocumentType extends \Elastic\OpenApi\Codegen\Endpoint\AbstractEndpoint
{
    // phpcs:disable
    /**
     * @var string
